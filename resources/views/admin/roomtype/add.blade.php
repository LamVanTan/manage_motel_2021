 ...
 <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0 btn btn-sm btn-primary">Thêm loại phòng</h3>
                </div>
            ...
            <div class="card-body">
              <form action="{{route('admin.roomtype.add')}}" method="POST">
                @csrf
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Nhập loại phòng vào đây" value="" name="roomtype">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
